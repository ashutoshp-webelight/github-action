...
import { useConfig, TypeAttributes } from "@uicore/contexts";
import { CONTROL_SIZES } from "@uicore/constants";
...
export const Input = forwardRef<ElementType | HTMLInputElement, InputProps>(
  (props, ref) => {
    const {
    ...
    // || inputGroupSize || formControlSize
